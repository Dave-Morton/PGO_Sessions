...
{
    global $debugArr, $srai_iterations, $quickdebug, $writetotemp, $last_timestamp, $debug_level;
    if ($debug_level === 0) return;

    $debug_level = (isset($_SESSION['convoArr']['conversation']['debug_level'])) ? $_SESSION['convoArr']['conversation']['debug_level'] : $debug_level;
 ...
 * @return void
 */
function handleDebug($et)
{
    global $debugArr, $debug_level, $debug_mode;

    $debug_level = (isset($_SESSION['convoArr']['conversation']['debug_level'])) ? $_SESSION['convoArr']['conversation']['debug_level'] : $debug_level;
    $debug_mode = (isset($_SESSION['convoArr']['conversation']['debugmode'])) ? $_SESSION['convoArr']['conversation']['debugmode'] : $debug_mode;
    $_SESSION['convoArr']['debug'] = $debugArr;
    $log = '';
    ...
    {
        //show the full array
        $showArr = $_SESSION['convoArr'];
        unset ($showArr['debug']);
    }
    else
    {
        //show a reduced array
        $showArr = reduceConvoArr();
    }
    ...
    switch ($debug_mode) {
        ...
        case 3 :
            //email to user
            $log = str_replace('[NEWLINE]', "\r\n", $log);
            email_debug($_SESSION['convoArr']['conversation']['debugemail'], $log);
            break;
    }
}
 ...
 * @return array
 */
function reduceConvoArr()
{
    runDebug(__FILE__, __FUNCTION__, __LINE__, 'Reducing the conversation array.', 0);

    $showConvoArr = array();
    $showConvoArr['conversation'] = (isset($_SESSION['convoArr']['conversation'])) ? $_SESSION['convoArr']['conversation'] : '';
    $showConvoArr['aiml'] = (isset($_SESSION['convoArr']['aiml'])) ? $_SESSION['convoArr']['aiml'] : '';
    $showConvoArr['topic'][1] = (isset($_SESSION['convoArr']['topic'][1])) ? $_SESSION['convoArr']['topic'][1] : '';
    $showConvoArr['that'][1] = (isset($_SESSION['convoArr']['that'][1])) ? $_SESSION['convoArr']['that'][1] : '';

    if (isset($_SESSION['convoArr']['aiml']['stars']))
    {
        foreach ($_SESSION['convoArr']['aiml']['stars'] as $index => $star) {
            if (!empty ($star)) {
    ...
    $showConvoArr['input'][1] = (isset($_SESSION['convoArr']['input'][1])) ? $_SESSION['convoArr']['input'][1] : '';
    $showConvoArr['stack']['top'] = (isset($_SESSION['convoArr']['stack']['top'])) ? $_SESSION['convoArr']['stack']['top'] : '';
    $showConvoArr['stack']['last'] = (isset($_SESSION['convoArr']['stack']['last'])) ? $_SESSION['convoArr']['stack']['last'] : '';
    $showConvoArr['client_properties'] = (isset($_SESSION['convoArr']['client_properties'])) ? $_SESSION['convoArr']['client_properties'] : '';
    $showConvoArr['aiml']['user_raw'] = (isset($_SESSION['convoArr']['aiml']['user_raw'])) ? $_SESSION['convoArr']['aiml']['user_raw'] : '';
    $showConvoArr['aiml']['lookingfor'] = (isset($_SESSION['convoArr']['aiml']['lookingfor'])) ? $_SESSION['convoArr']['aiml']['lookingfor'] : '';
    $showConvoArr['aiml']['pattern'] = (isset($_SESSION['convoArr']['aiml']['pattern'])) ? $_SESSION['convoArr']['aiml']['pattern'] : '';
    $showConvoArr['aiml']['thatpattern'] = (isset($_SESSION['convoArr']['aiml']['thatpattern'])) ? $_SESSION['convoArr']['aiml']['thatpattern'] : '';
    $showConvoArr['aiml']['topic'] = (isset($_SESSION['convoArr']['aiml']['topic'])) ? $_SESSION['convoArr']['aiml']['topic'] : '';
    $showConvoArr['aiml']['score'] = (isset($_SESSION['convoArr']['aiml']['score'])) ? $_SESSION['convoArr']['aiml']['score'] : '';
    $showConvoArr['aiml']['aiml_id'] = (isset($_SESSION['convoArr']['aiml']['aiml_id'])) ? $_SESSION['convoArr']['aiml']['aiml_id'] : '';
    $showConvoArr['aiml']['parsed_template'] = (isset($_SESSION['convoArr']['aiml']['parsed_template'])) ? $_SESSION['convoArr']['aiml']['parsed_template'] : '';
    $showConvoArr['user_say'][1] = (isset($_SESSION['convoArr']['user_say'][1])) ? $_SESSION['convoArr']['user_say'][1] : '';
    $showConvoArr['that_raw'][1] = (isset($_SESSION['convoArr']['that_raw'][1])) ? $_SESSION['convoArr']['that_raw'][1] : '';
    $showConvoArr['parsed_template'][1] = (isset($_SESSION['convoArr']['parsed_template'][1])) ? $_SESSION['convoArr']['parsed_template'][1] : '';
